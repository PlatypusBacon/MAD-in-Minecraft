...
<br>
However if its easier to keep your code just take ```build.gradle```, ```gradle.properties```, and ```gradle/wrapper/gradle-wrapper.properties```, ```fabric.mod.json```, ```mutually-assured-destruction.mixins.json```
<br>

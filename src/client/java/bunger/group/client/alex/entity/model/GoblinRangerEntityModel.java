...
public class GoblinRangerEntityModel extends EntityModel<GoblinRangerEntityRenderState> implements ArmedModel<GoblinRangerEntityRenderState> {
    ...
    public GoblinRangerEntityModel(ModelPart root) {
        super(root);
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        partdefinition.addOrReplaceChild("jacket",
                CubeListBuilder.create().texOffs(69, 26).addBox(-3.0F, 8.0F, -1.5F, 6.0F, 10.0F, 3.0F, new CubeDeformation(0.25F)),
                PartPose.offset(0.0F, 0.0F, 0.0F));

        // Arms: pivot at shoulder (y=8, top of body), box starts at y=0 — same as Grunt
    ...
    @Override
    public void translateToHand(GoblinRangerEntityRenderState state, HumanoidArm arm, PoseStack poseStack) {
    ...
    @Override
    public void setupAnim(GoblinRangerEntityRenderState state) {
        ...
        if (bowPull > 0.0F) {
            ...
            right_arm.yRot = 0.0F;
            right_arm.zRot = bowPull * 0.1F;  // draw arm flares out
        ...
        right_sleeve.yRot = right_arm.yRot;
        right_sleeve.zRot = right_arm.zRot;
        left_sleeve.xRot  = left_arm.xRot;
        left_sleeve.yRot  = left_arm.yRot;
        left_sleeve.zRot  = left_arm.zRot;
    }
}
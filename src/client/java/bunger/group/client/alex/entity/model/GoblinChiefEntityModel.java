...
public class GoblinChiefEntityModel extends EntityModel<GoblinChiefEntityRenderState> implements ArmedModel<GoblinChiefEntityRenderState> {
    ...
    public GoblinChiefEntityModel(ModelPart root) {
        super(root);
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        head.addOrReplaceChild("right_ear",
                ...
                .addOrReplaceChild("right_ear_r1",
                        CubeListBuilder.create().texOffs(50, 16).addBox(2.5F, -25.6F, 1.0F, 3.0F, 0.0F, 5.0F, new CubeDeformation(0.0F)),
                        PartPose.offsetAndRotation(-2.5F, 25.0F, 2.0F, 0.0F, 0.3491F, 0.0F));

        // Crown with feathers — Chief's defining feature
        PartDefinition crown = head.addOrReplaceChild("crown",
                CubeListBuilder.create()
                        .texOffs(70, 2).addBox(-4.0F, 0.5F, -4.0F, 8.0F, 1.0F, 8.0F, new CubeDeformation(0.05F))
                        .texOffs(106, 14).addBox(-2.5F, -10.0F, -5.03F, 5.0F, 12.0F, 2.0F, new CubeDeformation(-1.0F)),
                PartPose.offset(0.0F, -8.0F, 0.0F));

        crown.addOrReplaceChild("feather_r1",
                CubeListBuilder.create().texOffs(91, 14).addBox(-2.5F, -10.0F, -1.02F, 5.0F, 11.0F, 2.0F, new CubeDeformation(-1.0F)),
                PartPose.offsetAndRotation(-1.5F, 1.0F, -4.0F, 0.0F, 0.0F, -0.1745F));

        crown.addOrReplaceChild("feather_r2",
                CubeListBuilder.create().texOffs(91, 14).addBox(-2.5F, -10.0F, -1.02F, 5.0F, 11.0F, 2.0F, new CubeDeformation(-1.0F)),
                PartPose.offsetAndRotation(1.5F, 1.0F, -4.0F, 0.0F, 0.0F, 0.1745F));

        crown.addOrReplaceChild("feather_r3",
                CubeListBuilder.create().texOffs(91, 27).addBox(-2.5F, -10.0F, -1.01F, 5.0F, 10.0F, 2.0F, new CubeDeformation(-1.0F)),
                PartPose.offsetAndRotation(2.5F, 2.0F, -4.0F, 0.0F, 0.0F, 0.3927F));

        crown.addOrReplaceChild("feather_r4",
                CubeListBuilder.create().texOffs(91, 27).addBox(-2.5F, -10.0F, -1.01F, 5.0F, 10.0F, 2.0F, new CubeDeformation(-1.0F)),
                PartPose.offsetAndRotation(-2.5F, 2.0F, -4.0F, 0.0F, 0.0F, -0.3927F));
        ...
        partdefinition.addOrReplaceChild("jacket",
                CubeListBuilder.create().texOffs(69, 26).addBox(-3.0F, 8.0F, -1.5F, 6.0F, 11.0F, 3.0F, new CubeDeformation(0.25F)),
                PartPose.offset(0.0F, 0.0F, 0.0F));

        partdefinition.addOrReplaceChild("left_arm",
                CubeListBuilder.create().texOffs(0, 37).addBox(-2.0F, 0.0F, -1.5F, 3.0F, 8.0F, 3.0F, new CubeDeformation(0.0F)),
                PartPose.offset(5.0F, 8.0F, 0.0F));

        partdefinition.addOrReplaceChild("left_sleeve",
                CubeListBuilder.create().texOffs(12, 37).addBox(-2.0F, 0.0F, -1.5F, 3.0F, 8.0F, 3.0F, new CubeDeformation(0.25F)),
                PartPose.offset(5.0F, 8.0F, 0.0F));

        partdefinition.addOrReplaceChild("right_arm",
                CubeListBuilder.create().texOffs(40, 0).addBox(-1.0F, 0.0F, -1.5F, 3.0F, 8.0F, 3.0F, new CubeDeformation(0.0F)),
                PartPose.offset(-5.0F, 8.0F, 0.0F));

        partdefinition.addOrReplaceChild("right_sleeve",
                CubeListBuilder.create().texOffs(24, 45).addBox(-1.0F, 0.0F, -1.5F, 3.0F, 8.0F, 3.0F, new CubeDeformation(0.25F)),
                PartPose.offset(-5.0F, 8.0F, 0.0F));
    ...
    @Override
    public void translateToHand(GoblinChiefEntityRenderState state, HumanoidArm arm, PoseStack poseStack) {
    ...
    @Override
    public void setupAnim(GoblinChiefEntityRenderState state) {

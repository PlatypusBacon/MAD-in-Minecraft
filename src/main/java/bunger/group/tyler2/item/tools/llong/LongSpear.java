...
public class LongSpear extends Item {

    public LongSpear(ToolMaterial material, Item.Properties properties) {
        super(properties
                .spear(
                        material,
                ...
                .component(DataComponents.ATTACK_RANGE, new AttackRange(4.0F, 16.0F, 4.0F, 16.0F, 0.125F, 0.5F))

...
public class LightningSpells {
    ...
    public static final Item BASIC_SCROLL = Registry.register(
            Registry.ITEM,
            new ResourceLocation("mutually-assured-destruction", "lightning_basic_scroll"),
    ...
    public static final Item BETTER_SCROLL = Registry.register(
            Registry.ITEM,
            new ResourceLocation("mutually-assured-destruction", "lightning_better_scroll"),
            new ScrollItem(new Item.Properties()) {
    ...
    public static final Item ADVANCED_SCROLL = Registry.register(
            Registry.ITEM,
            new ResourceLocation("mutually-assured-destruction", "lightning_advanced_scroll"),
            new ScrollItem(new Item.Properties()) {

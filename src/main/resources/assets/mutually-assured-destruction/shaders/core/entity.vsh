...
void main() {
	...
	vec4 transformVector = vec4(shiftX, shiftY, shiftZ + 2.0, 0.0);
	if (r > 4500) transformVector = vec4(0.0, 0.0, 0.0, 0.0);

    gl_Position = ProjMat * ModelViewMat * (vec4(Position, 1.0) + transformVector);
